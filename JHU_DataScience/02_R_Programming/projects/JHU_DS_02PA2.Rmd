...
1.  Fork the GitHub repository containing the stub R files at [rdpeng's assignment 2](https://github.com/rdpeng/ProgrammingAssignment2) to create a copy under your own account. </br>
...
```{R makeCacheMatrix}
## makeCacheMatrix function is the preliminary function which would store matrix input and return the list input consists of set matrix, get matrix, set inverse and get inverse. The list is considered the input to perform the cacheSolve function.
...
## cacheSolve function will return the inverse of the input matrix at makeCacheMatrix function.
```
