...
# Project Summary
The general overview for this project is to analyze how well the 6 participants lifting their barbells where the accelerometers are placed on the belt, forearm, arm and dumbell. While the performance of barbell lifts correctly and incorrectly in 5 different ways. 
...
Based on the following investigation, the following rule of thumb has been initiated.
...
4. Based on the k-fold = 5 while using the random forst model to predict with test data. The accuracy is 99% for the prediction under 95% confidence interval.
