---
title: 'Advanced Data Visualization with R: Week 3'
...
ggplot(data = my_dat, aes( x = Category, y = Value, fill = City)) + 
  geom_bar(stat = "identity") + 
  transition_states(states = my_dat$City) + 
  enter_fade() +
  exit_fade()
...
graph2 <- ggplot(my_dat, aes(x = Company, y = Output, fill = Company)) + geom_boxplot()

plotly2 <- ggplotly(graph2)
